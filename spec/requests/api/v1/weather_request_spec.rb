...
describe 'Weather Forecast', :vcr do
    it 'can return weather forecast based on location' do
        ...
        weekly_forecast = weather_forecast['weekly_forecast_results'][0]
        ...
        expect(weekly_forecast).to have_key('time')
        expect(weekly_forecast).to have_key('temperature_low')
        expect(weekly_forecast).to have_key('summary')
        expect(weekly_forecast).to have_key('temperature_high')
        expect(weekly_forecast).to have_key('humidity')
